_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = "1.00",
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops. It represents 0.68 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops. It represents 0.68 seconds.",
